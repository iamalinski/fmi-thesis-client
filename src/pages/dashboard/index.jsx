...
const topClients = [
  ...
  {
    id: 2,
    name: "Техно Солюшънс АД",
    totalSpent: "21,340.00",
    invoicesCount: 14,
    avatarColor: "#f44336",
  },
  {
    id: 3,
    name: "Експрес Логистикс ЕООД",
    totalSpent: "18,920.00",
    invoicesCount: 11,
    avatarColor: "#4caf50",
  },
  {
    id: 4,
    name: "Строй Инвест ООД",
    totalSpent: "15,780.00",
    invoicesCount: 9,
    avatarColor: "#ff9800",
  },
  {
        ...
        <Grid item xs={12}>
          ...
          >
            ...
            {topProducts.map((product, index) => (
              <Box
                key={product.name}
                sx={{ mb: index !== topProducts.length - 1 ? 2 : 0 }}
              >
                <Box
                  sx={{
                    display: "flex",
